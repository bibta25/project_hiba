...
<nav>
    ...
    <div class="logo">
        <img src="../project_hiba/img/logo1.png">
    </div>

    <ul>
        <li><a href="homeM.php">Home</a></li>
        <li><a href="#about">About</a></li>
        <li><a href="plantes.php">Books</a></li>
    ...
    <div class="social_icon" >
        <a href="searchM.php" style="font-size :20px">🔎</a>
        <a href="logoutM.php"><i class='bx bx-log-out' style="font-size :25px; color: black;"></i></a>
    </div>
...
<div class="book-review-container">
    <div class="book-details">
        ...
        <a href="register_openingM.php?book_id=<?php echo $book['id']; ?>" >Open</a>
        <a href="register_downloadM.php?book_id=<?php echo $book['id']; ?>" download>Download</a>
        ...
        <div class="rating-container">
            <div class="stars" >
                <form action="submit_ratingM.php" method="post">
